...
//            String response = getDataFromAPI(keyword, display, start, sort);
            ...
            File file = new File("src/Devcos/AIBE/study_250227/%d_%s.txt".formatted(new Date().getTime(), keyword));
            if (!file.exists()) {
...
//            logger.info(imageResponse);
            ...
            Path path = Path.of("src/Devcos/AIBE/study_250227/%d_%s.%s".formatted(
